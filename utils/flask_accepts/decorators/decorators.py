...
from typing import Type, Union, Sequence, Set
    ...
    *args,
    ...
    Args:
        *args: any number of dictionaries containing parameters to pass to
        ...
        partial (bool, optional): The Marshmallow schema `partial` parameter, which will
            skip required validation when set to True. This flag corresopnds only to the request body schema,
            and not the `query_params_schema` or `headers_schema` arguments.
    ...
    def decorator(func):
        ...
        def inner(*args, **kwargs):
            ...
            if schema:
                try:
                    obj = schema.load(request.get_json(force=True), partial=partial)
